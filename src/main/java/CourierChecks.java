...
public class CourierChecks {
    ...
    @Step("Success login")
    public int loginSuccess(ValidatableResponse loginResponse) {        loginResponse
            .assertThat()
    ...
    public void loginWithUncorrectCreds(ValidatableResponse loginResponse) {        loginResponse
            .assertThat()
