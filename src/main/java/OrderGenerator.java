...
public class OrderGenerator {
    ...
    public static Order getWithBlackColor() {
        return new Order("Snezhana", // Имя заказчика
                "Rodinkova", // Фамилия заказчика
                "Rostov-na-Donu, Lenina, 10", // Адрес доставки
                "Polyarnaya", // Станция метро
                "+7 (913) 974 58 00", // Номер телефона заказчика
                3, // Время аренды (дней)
                "2025-05-27", // Дата доставки
    ...
    public static Order getWithGreyColor() {
        return new Order("Snezhana", // Имя заказчика
                "Rodinkova", // Фамилия заказчика
                "Rostov-na-Donu, Lenina, 12", // Адрес доставки
                "Lenina", // Станция метро
                "+7-913-973-58-35", // Номер телефона заказчика
                1, // Время аренды (дней)
                "2025-05-28", // Дата доставки
                "Спасибо!", // Комментарий к заказу
    ...
    public static Order getWithBlackAndGrayColors() {
        return new Order("Snezhana", // Имя заказчика
                "Rodinkova", // Фамилия заказчика
                "Rostov-na-Donu, Lenina, 13", // Адрес доставки
                "Tyumen", // Станция метро
                "7 913 973 58 35", // Номер телефона заказчика
                6, // Время аренды (дней)
                "2025-05-29", // Дата доставки
                "Спасибо!", // Комментарий к заказу
    ...
    public static Order getWithoutColor() {
        return new Order("Snezhana", // Имя заказчика
                "Rodinkova", // Фамилия заказчика
                "Rostov-na-Donu, Lenina, 14", // Адрес доставки
                "Magistal", // Станция метро
                "89139735813", // Номер телефона заказчика
                9, // Время аренды (дней)
                "2025-05-30", // Дата доставки
                "Спасибо!", // Комментарий к заказу
